...
class AudioLanguageIntelligenceTest {
    ...
    @Test
    fun extractorTrackTypeOrdering() {
    ...
    fun extractorXtagsParsing() {
        ...
        assertEquals("en", AudioLanguageIntelligence.normalizeLanguage("en-US"))
        ...
        assertEquals("it", AudioLanguageIntelligence.normalizeLanguage(AudioLanguageIntelligence.extractXtag(extractedXtags, "lang")))
    }
