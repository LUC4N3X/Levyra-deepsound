...
internal object RuntimePreflight {
    private const val MAX_ASSET_BYTES = 262_144
...
internal fun providerEndpointAllowed(value: String): Boolean {
    val uri = Uri.parse(value)
    return uri.scheme == "https" && uri.host == "api.github.com" && uri.userInfo == null && uri.port == -1 &&
        uri.path.orEmpty().startsWith("/repos/LUC4N3X/Levyra-deepsound/")
}
