...
private val downloadLocationBundles: Map<String, Map<String, String>> = mapOf(
    ...
    "fi" to downloadLocation("Lataussijainti", "Valitse sisäinen tallennustila tai SD-kortin kansio", "Music/Levyra (oletus)", "Käytä oletuskansiota", "Tallenna tulevat lataukset kansioon Music/Levyra", "Valittu kansio ei ole saatavilla — käytetään kansiota Music/Levyra", "Levyra ei voinut säilyttää kirjoitusoikeutta tähän kansioon"),
    "et" to downloadLocation("Allalaadimise asukoht", "Vali sisemälu või SD-kaardi kaust", "Music/Levyra (vaikimisi)", "Kasuta vaikekausta", "Salvesta tulevased allalaadimised kausta Music/Levyra", "Valitud kaust pole saadaval — kasutatakse kausta Music/Levyra", "Levyral ei õnnestunud säilitada sellesse kausta kirjutamise õigust")
)
