...
private val playerDeckBundles: Map<String, Map<String, String>> = mapOf(
    ...
    "fi" to playerDeck("Player Deck", "Sama musiikki, eri näyttämö. Vaihtaminen ei koskaan keskeytä toistoa.", "Toimituksellinen", "Pulse", "Levyran tunnusomainen näyttämö: kansikuva ja Canvas täyttävät näytön.", "Canvas kehystettynä kelluvassa kortissa pehmeällä hehkulla.", "Staattinen kansikuva, rauhallinen ja keskittynyt.", "Aikakauslehden kansiasettelu vahvalla typografialla ja kappalenumerolla.", "Reaaliaikainen signaalilinja ja äänimuodon tiedot.", "Vaakatila, video ja live-radio käyttävät aina Levyra-asettelua."),
    "et" to playerDeck("Player Deck", "Sama muusika, erinev lava. Vahetamine ei katkesta kunagi taasesitust.", "Toimetuslik", "Pulse", "Levyra iseloomulik lava: kaanepilt ja Canvas täidavad ekraani.", "Canvas raamitud hõljuvas pehme kumaga kaardis.", "Staatiline kaanepilt, rahulik ja keskendunud.", "Ajakirja kaanekujundus julge tüpograafia ja loo numbriga.", "Reaalajas helisignaal ja helivormingu üksikasjad.", "Rõhtpaigutus, video ja otseraadio kasutavad alati Levyra paigutust.")
)
