...
class LevyraStrings private constructor(
    ...
    val trendingToday: String get() = value("trendingToday")
    ...
    val enteredChartsToday: String get() = value("enteredChartsToday")
    ...
    companion object {
        ...
        private fun bundle(code: String, entries: Map<String, String>): LevyraStrings {
            val resolvedEntries = entries + homeEditorialLocalizationEntries(code)
