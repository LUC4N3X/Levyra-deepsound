...
class LevyraStrings private constructor(
    ...
    val jamAddedBy: String get() = value("jamAddedBy")
    val jamNoParticipants: String get() = value("jamNoParticipants")
    val jamNoPendingRequests: String get() = value("jamNoPendingRequests")
    ...
    companion object {
        ...
        private fun bundle(code: String, entries: Map<String, String>): LevyraStrings {
            ...
            val allRequiredKeys = requiredKeys + "removeFromPlaylist" + motionArtworkKeys + canvasKeys + audioKeys + alternativeAudioKeys + autoEqKeys + experienceKeys + insightKeys + systemActionKeys + integrationKeys + recognitionKeys + jamKeys + jamModerationKeys + ambientModeKeys + themeStudioKeys + networkKeys + resonanceKeys + organizationKeys + downloadLocationKeys + similarSongsKeys + playerVisualKeys + queueSelectionKeys + librarySortKeys + offlineHomeKeys + recapKeys + listeningInsightsKeys
