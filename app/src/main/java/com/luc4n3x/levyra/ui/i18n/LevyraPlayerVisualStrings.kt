...
internal fun playerVisualLocalizationEntries(code: String): Map<String, String> =
    (playerVisualBundles[code] ?: playerVisualBundles.getValue("en")) + liveChatLocalizationEntries(code) + diagnosticsLocalizationEntries(code)
