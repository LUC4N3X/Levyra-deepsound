...
private val playerExperienceBundles: Map<String, Map<String, String>> = mapOf(
    ...
    "fi" to playerExperience("Sinun äänesi, ilman rajoja.", "Miljoonia kappaleita, synkronoidut sanoitukset ja offline-kuuntelu yhdessä soittimessa, joka ei ole tiellä.", "Saumaton toisto ja täysi äänimoottori", "Synkronoidut sanoitukset, sana sanalta", "Offline-lataukset kansikuvilla ja tunnisteilla", "Aloita", "Laajenna soitin", "Pienennä soitin", "Keskity"),
    "et" to playerExperience("Sinu heli, piirideta.", "Miljonid lood, sünkroonitud sõnad ja võrguühenduseta kuulamine ühes mängijas, mis ei jää ette.", "Pausideta taasesitus ja täielik helimootor", "Sünkroonitud laulusõnad, sõna-sõnalt", "Võrguühenduseta allalaadimised kaante ja siltidega", "Alusta", "Laienda mängijat", "Ahenda mängija", "Fookus")
)

internal fun playerExperienceLocalizationEntries(code: String): Map<String, String> =
    localizedBundleOrEnglish(playerExperienceBundles, code)
