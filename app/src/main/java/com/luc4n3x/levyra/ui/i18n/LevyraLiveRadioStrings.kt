...
internal object LevyraLiveRadioCatalog {
    ...
    private val values = mapOf(
        ...
        "uk" to radio("Живі станції з усього світу", "Популярні в %s", "Увесь світ", "Категорії", "Країни", "Мови", "Пошук за назвою, країною, тегом або мовою", "Станцій не знайдено", "Показано збережені станції", "Для живого радіо потрібен інтернет", "Завантажити ще", englishCategories),
        "ru" to radio("Радиостанции со всего мира", "Популярно в %s", "Весь мир", "Категории", "Страны", "Языки", "Поиск по названию, стране, тегу или языку", "Станции не найдены", "Показаны сохранённые станции", "Для радио нужен интернет", "Загрузить ещё", englishCategories),
        ...
        "ja" to radio("世界中のライブラジオ", "%s で人気", "世界中", "カテゴリ", "国", "言語", "名前、国、タグ、言語で検索", "該当するライブ局はありません", "再接続中は保存済みの局を表示します", "ライブラジオにはインターネットが必要です", "さらに読み込む", englishCategories),
        "ko" to radio("전 세계 라이브 라디오", "%s 인기 방송", "전 세계", "카테고리", "국가", "언어", "이름, 국가, 태그 또는 언어로 검색", "일치하는 라이브 방송이 없습니다", "재연결 중 저장된 방송을 표시합니다", "라이브 라디오에는 인터넷이 필요합니다", "더 불러오기", englishCategories),
        "hi" to radio("दुनिया भर के लाइव स्टेशन", "%s में लोकप्रिय", "दुनिया भर", "श्रेणियाँ", "देश", "भाषाएँ", "नाम, देश, टैग या भाषा से खोजें", "कोई लाइव स्टेशन नहीं मिला", "दोबारा जुड़ते समय सहेजे स्टेशन दिखाए जा रहे हैं", "लाइव रेडियो के लिए इंटरनेट चाहिए", "और लोड करें", englishCategories),
        ...
        "th" to radio("สถานีสดจากทั่วโลก", "ยอดนิยมใน %s", "ทั่วโลก", "หมวดหมู่", "ประเทศ", "ภาษา", "ค้นหาตามชื่อ ประเทศ แท็ก หรือภาษา", "ไม่พบสถานีสดที่ตรงกัน", "แสดงสถานีที่บันทึกไว้ระหว่างเชื่อมต่อใหม่", "ต้องใช้อินเทอร์เน็ตสำหรับวิทยุสด", "โหลดเพิ่ม", englishCategories),
        ...
        "he" to radio("תחנות חיות מכל העולם", "פופולרי ב%s", "בכל העולם", "קטגוריות", "מדינות", "שפות", "חיפוש לפי שם, מדינה, תגית או שפה", "לא נמצאו תחנות חיות", "מציג תחנות שמורות בזמן החיבור", "נדרש אינטרנט לרדיו חי", "טען עוד", englishCategories)
