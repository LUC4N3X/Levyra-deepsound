...
private val experienceBundles: Map<String, Map<String, String>> = mapOf(
    ...
    "fi" to experience("Levyra Mix", "Luo miksaus", "Käynnistä radio", "Tuttu", "Löytö", "Yllätä minut", "Tallenna tämä valinta", "Miksausta ei voitu luoda juuri nyt.", "Äänesi", "Miten todella kuuntelet", "7 päivää", "30 päivää", "6 kuukautta", "Koko aika", "Uusi musiikki", "Kuuntelurytmi", "Kuuntele muutama kappale, niin äänesi ilmestyy tähän.", "Löydä lisää"),
    "et" to experience("Levyra Mix", "Loo miks", "Käivita raadio", "Tuttav", "Avastus", "Üllata mind", "Salvesta see valik", "Praegu ei saanud miksi luua.", "Sinu kõla", "Kuidas sa tegelikult kuulad", "7 päeva", "30 päeva", "6 kuud", "Kogu aeg", "Uus muusika", "Kuulamisrütm", "Kuula paari lugu ja sinu kõla ilmub siia.", "Avasta rohkem")
)

internal fun experienceLocalizationEntries(code: String): Map<String, String> = localizedBundleOrEnglish(experienceBundles, code)
