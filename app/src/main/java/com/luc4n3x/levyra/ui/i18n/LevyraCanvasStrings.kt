...
private val canvasBundles: Map<String, Map<String, String>> = mapOf(
    ...
    "he" to canvasStrings("איכות Canvas", "מצב אוטומטי מתאים את עצמו לרשת, לסוללה ולמסך; גבוהה שומרת על ה-Canvas החד ביותר", "מקור Canvas", "בחר איזה ספק יספק את המוטיון ארטוורק", "קהילה", "שיתוף פלייליסט של Levyra", "כותרות וידאו טובות יותר", "שימוש בכותרות ובתמונות ממוזערות של הקהילה בסרטונים בלבד", "זיהוי מוזיקה", "טעינת Canvas רק ב-Wi-Fi", "הגבלת טעינת אנימציות Canvas לרשתות Wi-Fi בלבד"),
    "fi" to canvasStrings("Canvas-laatu", "Automaattinen seuraa verkkoa, akkua ja näyttöä; Korkea säilyttää terävimmän canvasin", "Canvas-lähde", "Valitse, mikä palveluntarjoaja toimittaa animoidun kansikuvan", "Yhteisö", "Jaa Levyra-soittolista", "Paremmat videoiden nimet", "Käytä yhteisön nimiä ja pikkukuvia vain videoissa", "Tunnista musiikki", "Lataa Canvas vain Wi-Fi-verkossa", "Rajoita Canvas-animaatioiden lataus vain Wi-Fi-verkkoihin"),
    "et" to canvasStrings("Canvas kvaliteet", "Automaatne järgib võrku, akut ja ekraani; Kõrge hoiab teravaimat canvast", "Canvas allikas", "Vali, milline pakkuja varustab animeeritud kaanepilti", "Kogukond", "Jaga Levyra esitusloendit", "Paremad videote pealkirjad", "Kasuta kogukonna pealkirju ja pisipilte ainult videotel", "Tuvasta muusika", "Laadi Canvas ainult Wi-Fi kaudu", "Piira Canvas animatsioonide laadimine ainult Wi-Fi võrkudesse")
)

internal fun canvasLocalizationEntries(code: String): Map<String, String> = localizedBundleOrEnglish(canvasBundles, code)
