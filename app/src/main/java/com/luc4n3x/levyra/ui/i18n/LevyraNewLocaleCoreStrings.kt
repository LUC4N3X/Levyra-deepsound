...
internal fun newLocaleCoreOverrides(code: String): Map<String, String> = when (code) {
    ...
    "fi" -> coreCopy("Aloitetaan.", "Mikä on kielesi?", "Mikä nimesi on?", "Valitse vähintään 3 suosikkigenreäsi.", "Ohita ja jatka", "Aloita kuuntelu", "Asetukset", "Mukauta LEVYRAa", "Kieli", "Vaihda sovelluksen kieli", "Koti", "Haku", "Kirjasto", "Soitin", "Jono", "Sanoitukset", "Soittolistat", "Offline-lataukset", "Suosikit", "Pikavalinnat", "Toista", "Hae kappaleita, artisteja ja muuta…", "Takaisin", "Valitse kieli", "Käynnistetäänkö LEVYRA uudelleen?", "Kieli on tallennettu. Käynnistä sovellus uudelleen, jotta kaikki näkymät latautuvat uudella kielellä.", "Käynnistä nyt", "Myöhemmin")
