...
<picture><source media="(max-width: 480px)" srcset="docs/assets/levyra-windows-download-mobile.svg?v=responsive2"><img src="docs/assets/levyra-windows-download.svg?v=responsive2" alt="Download Levyra for Windows"></picture></a>
</p>
