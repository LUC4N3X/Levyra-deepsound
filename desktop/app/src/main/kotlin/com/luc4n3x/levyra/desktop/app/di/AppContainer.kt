...
import com.luc4n3x.levyra.desktop.app.state.LocalMusicController
...
class AppContainer {
    ...
    val localLibraryStore: LocalLibraryStore = LocalLibraryStore.create(paths)
